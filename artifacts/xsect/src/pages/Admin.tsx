...
function PlansTab() {
  ...
  return <section className="rounded-2xl border bg-white p-6">
    <h2 className="font-bold">Demo plan overrides</h2><p className="text-sm text-muted-foreground mt-1 mb-5">Overrides take precedence over Stripe and are enforced by the backend.</p>
